...
<head>
  ...
  <title>English Lessons - SpeakUp</title>
  ...
  <nav class="navbar">
    <div class="nav-container">
      ...
      <ul class="nav-menu">
        ...
        <li class="nav-item">
          <a href="../dashboard/progress.html" class="nav-link">Progress</a>
        </li>
        <li class="nav-item">
    ...
    <div class="container">
      ...
      <section class="practice-header">
        <div class="header-content">
          ...
          <p>Work through 15 bite-size lessons to build your English skills.</p>
        </div>
      </section>
      ...
      <section class="lesson-selection">
        ...
        <div class="lessons-grid">
          <?php
            ...
            $sql = "SELECT * FROM lessons WHERE language = 'english' ORDER BY id ASC";
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    // Check if locked vs unlocked based on ID or simply just unlocked for now as users can access them
                    // Or follow the original logic where some are 'coming soon'.
                    // For now, let's unlock all 6 present in the database.
                    ?>
                    <div class="lesson-card" onclick="window.location.href='lesson.php?id=<?php echo $row['id']; ?>'">
                        ...
                        <div class="lesson-badges">
                            ...
                            <span class="lesson-level <?php echo $row['level']; ?>">Lesson <?php echo $row['id']; ?></span>
                        </div>
                        </div>
