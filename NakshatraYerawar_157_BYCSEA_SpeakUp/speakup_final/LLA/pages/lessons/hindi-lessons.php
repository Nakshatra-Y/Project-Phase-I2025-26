...
<head>
  ...
  <title>Hindi Lessons - SpeakUp</title>
    ...
    <div class="container">
      ...
      <section class="practice-header">
        <div class="header-content">
          <button class="back-btn" onclick="window.location.href='practice.html'" style="
          ...
          <h1>Hindi Lessons</h1>
          <p>Work through 15 bite-size lessons to build your Hindi skills.</p>
        </div>
      </section>
      ...
      <section class="lesson-selection">
        ...
        <div class="lessons-grid">
          <?php
            // Fetch Hindi lessons
            $sql = "SELECT * FROM lessons WHERE language = 'hindi' ORDER BY id ASC";
