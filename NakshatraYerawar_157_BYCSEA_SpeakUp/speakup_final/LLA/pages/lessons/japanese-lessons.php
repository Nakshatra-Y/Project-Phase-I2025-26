...
<head>
  ...
  <title>Japanese Lessons - SpeakUp</title>
    ...
    <div class="container">
      ...
      <section class="practice-header">
        <div class="header-content">
          ...
          <p>Work through 15 bite-size lessons to build your Japanese skills.</p>
        </div>
      </section>
      ...
      <section class="lesson-selection">
        ...
        <div class="lessons-grid">
          <?php
            // Fetch Japanese lessons
            $sql = "SELECT * FROM lessons WHERE language = 'japanese' ORDER BY id ASC";
